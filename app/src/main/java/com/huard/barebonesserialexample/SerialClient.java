...
public class SerialClient implements AutoCloseable {
    public static final String ACTION_USB_PERMISSION = "com.huard.barebonesserialexample.USB_PERMISSION";
    ...
    public SerialClient(@NonNull Context context, Handler terminalHandler, Handler connectionHandler) {
        ...
        intentPermissionUSB = PendingIntent.getBroadcast(context, 0, intent, PendingIntent.FLAG_IMMUTABLE);
